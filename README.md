...
A local AI assistant with RAG (Retrieval-Augmented Generation), PDF document search, web search, and voice I/O — powered by a local LLaMA-compatible model and optional Google Gemini.
